...
function customer() {
  return (
    <div className="container py-[10rem]">
      <Card className="max-w-sm rounded-[2rem] bg-[#332727]">
      <h5 className="mb-3 text-base font-semibold text-gray-900 lg:text-xl text-center dark:text-white">Connect wallet</h5>
