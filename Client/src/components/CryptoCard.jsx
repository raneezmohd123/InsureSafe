...
function CryptoCard({data}) {
  ...
  return (
    <>
       ...
       {isOpen&&(
        <div className=" bg-zinc-800 text-white w-[22rem] p-4  rounded-md top-0 right-1 h-[100%] border-r `ease-in-out duration-500' : 'transition-all  ease-in-out duration-400 fixed `">
            ...
            <ul>
                <li className="mb-4">
                    <button className={buttonClasses}>
                        <img src="https://placehold.co/32x32" alt="Uniswap Wallet" className={imageClasses} />
                        Uniswap Wallet
                    </button>
                </li>
                <li className="mb-4">
                    <button className={buttonClasses}>
                        <img src="https://placehold.co/32x32" alt="MetaMask" className={imageClasses} />
                        MetaMask
                    </button>
                </li>
                <li className="mb-4">
                    <button className={buttonClasses}>
                        <img src="https://placehold.co/32x32" alt="WalletConnect" className={imageClasses} />
                        WalletConnect
                    </button>
                </li>
                <li className="mb-4">
                    <button className={buttonClasses}>
                        <img src="https://placehold.co/32x32" alt="Coinbase Wallet" className={imageClasses} />
                        Coinbase Wallet
                    </button>
                </li>
            </ul>
